...
if __name__ == "__main__":
    ...
    #
    ny,nx = l.d.shape[0:2]
    obs = np.zeros((ny,nx,4,iw.size), dtype='float64', order='c')
    ...
    #
    sig= np.zeros((4,iw.size), dtype='float64') + 1.e34
    sig[:,idx] = 3.e-3
    ...
    #
    tw1 = (np.arange(75, dtype='float64')-75//2)*0.005
    tw2 = (np.arange(25, dtype='float64')-25//2)*0.015
